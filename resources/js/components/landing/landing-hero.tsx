        ...
        <section className="landing-hero-bg relative overflow-hidden pt-32 pb-20 sm:pt-36 sm:pb-28">
            <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="text-muted-foreground mx-auto mt-5 max-w-2xl text-lg leading-relaxed sm:text-xl">
                ...
                {/* Product shot is cropped so it bleeds past the viewport edge,
                    ...
                    hard line. */}
                <div className="relative mt-14 max-h-[620px] overflow-hidden sm:mt-16">
